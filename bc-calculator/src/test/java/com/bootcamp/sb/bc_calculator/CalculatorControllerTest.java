package com.bootcamp.sb.bc_calculator;
...
import com.bootcamp.sb.bc_calculator.controller.impl.CalculatorController;
...
public class CalculatorControllerTest {
  ...
  void testCalculate3Add() throws Exception {
    ...
    Mockito.when(calculatorService.calculator(convertX, convertY, mockApiRequest.getOperation()))
      .thenReturn(mockApiResponse);

    mockMvc.perform(MockMvcRequestBuilders.post("/operation")
      .contentType(MediaType.APPLICATION_JSON_VALUE)
      .content(new ObjectMapper().writeValueAsString(mockApiRequest)))
    ...
    .andExpect(MockMvcResultMatchers.content().json("{\"x\":\"1\",\"y\":\"2\",\"operation\":\"add\",\"result\":\"3.0\"}"));
  }
}
